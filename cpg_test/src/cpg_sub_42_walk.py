...
class CPGsub:
    def __init__(self):
        self.sub1 = rospy.Subscriber("leg1j1",Float64,self.cb1)
        self.sub2 = rospy.Subscriber("leg1j2",Float64,self.cb2)
    ...
    def main(self):
        while not rospy.is_shutdown():
            ...
            #self.j2=[self.l4j3,self.l4j1,self.l4j2,self.l5j1,self.l5j2,self.l5j3,self.l6j3,self.l6j1,self.l6j2]
            self.j2=[self.l4j3,self.l4j1,self.l4j2,self.l5j1,self.l5j2,self.l5j3,self.l6j3,self.l6j1,self.l6j2]
           # self.j=[self.l1j1,self.l1j2,self.l1j3,self.l2j1,self.l2j2,self.l2j3,self.l3j1,self.l3j2,self.l3j3]
            self.j = [self.l1j1,self.l1j2,self.l1j3,self.ang1,self.ang3,self.l2j3,self.ang2,self.ang3,self.l3j3]
