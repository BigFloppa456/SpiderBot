...
class CPG:
    def __init__(self):
        ...
        self.pub1 = rospy.Publisher("leg4j2",Float64,queue_size=10)
    ...
    def update_values(self,amp_target = 0.2, offset_target = np.array([1.745,1.745]), frequency_target =  [0.08,0.08], phase_offset_target = pi):
